...
const ClosedEye: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M20.9994 3L17.6094 6.39" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M6.38 17.62L3 21" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path
